      ...
      var e = {
          997: (e, t, n) => {
            ...
            class l extends r.BaseCommand {
              constructor() {
                super(...arguments), (this.workspaces = []), (this.json = !1), (this.production = !1), (this.all = !1)
              }
              async execute() {
                ...
                return (
                  await a.StreamReport.start(
                    ...
                    async e => {
                      await t.install({ cache: o, report: e, persistProject: !1 })
                    }
                  )
                ).exitCode()
              }
            ...
            ;(l.usage = s.Command.Usage({
              ...
              (l.schema = i.object().shape({
                ...
                workspaces: i.array().when("all", {
                  is: !0,
                  then: i.array().max(0, "Cannot specify workspaces when using the --all flag"),
                  otherwise: i.array(),
                }),
              })),
              o([s.Command.Rest()], l.prototype, "workspaces", void 0),
              o(
                [s.Command.Boolean("--json", { description: "Format the output as an NDJSON stream" })],
                l.prototype,
                "json",
                void 0
              ),
              ...
              o(
                [s.Command.Boolean("-A,--all", { description: "Install the entire project" })],
                l.prototype,
                "all",
                void 0
              ),
              o([s.Command.Path("workspaces", "focus")], l.prototype, "execute", null)
            var u = n(401),
              p = n.n(u)
            const c = require("os")
            var d = n(578),
            ...
            const h = (e, t) => {
              ...
              g = (e, t) => {
                const n = new Set(),
                  o = e => {
                    const r = new Map([...e.manifest.dependencies, ...e.manifest.devDependencies])
            ...
            class A extends r.BaseCommand {
              ...
              async execute() {
                var e
                const t = await a.Configuration.find(this.context.cwd, this.context.plugins),
                  { project: n, workspace: o } = await a.Project.find(t, this.context.cwd),
                  i = null !== (e = this.all) && void 0 !== e ? e : this.allLegacy
                if (!i && !o) throw new r.WorkspaceRequiredError(n.cwd, this.context.cwd)
                const l = this.cli.process([this.commandName, ...this.args]),
                  u = 1 === l.path.length && "run" === l.path[0] && void 0 !== l.scriptName ? l.scriptName : null
                if (0 === l.path.length)
                ...
                for (const e of A)
                  (!u || e.manifest.scripts.has(u) || u.includes(":")) &&
                    ((u === process.env.npm_lifecycle_event && e.cwd === o.cwd) ||
                      (this.include.length > 0 &&
                        !p().isMatch(a.structUtils.stringifyIdent(e.locator), this.include)) ||
                      (this.exclude.length > 0 && p().isMatch(a.structUtils.stringifyIdent(e.locator), this.exclude)) ||
                ...
                let v = 0,
                  x = null,
                  w = !1
                const S = await a.StreamReport.start({ configuration: t, stdout: this.context.stdout }, async e => {
                  const o = async (n, { commandIndex: o }) => {
                    if (w) return -1
                    !this.parallel && this.verbose && o > 1 && e.reportSeparator()
                    const r = (function (e, { configuration: t, commandIndex: n, verbose: o }) {
                      ...
                      })(n, { configuration: t, verbose: this.verbose, commandIndex: o }),
                      [s, i] = y(e, { prefix: r, interlaced: m }),
                      [l, u] = y(e, { prefix: r, interlaced: m })
                    try {
                      const t =
                        (await this.cli.run([this.commandName, ...this.args], { cwd: n.cwd, stdout: s, stderr: l })) ||
                        0
                      s.end(), l.end()
                      const o = await i,
                        a = await u
                      return (
                        this.verbose &&
                          o &&
                          a &&
                          e.reportInfo(null, `${r} Process exited without output (exit code ${t})`),
                        130 === t && ((w = !0), (x = t)),
                        t
                      )
                    } catch (e) {
                  ...
                  for (; _.size > 0 && !e.hasErrors(); ) {
                    ...
                    for (const [e, t] of _) {
                      ...
                      if (this.topological || this.topologicalDev) {
                        ...
                        for (const t of e.values()) {
                          ...
                          if (((a = null === e || !_.has(e.anchoredLocator.locatorHash)), !a)) break
                        }
                      }
                      if (
                        a &&
                        ...
                        r.push(
                          b(async () => {
                            ...
                            return _.delete(e), E.delete(t.anchoredDescriptor.descriptorHash), n
                          })
                        ),
                        !this.parallel)
                      )
                    ...
                    if (0 === r.length) {
                      const n = Array.from(_.values())
                        .map(e => a.structUtils.prettyLocator(t, e.anchoredLocator))
                        .join(", ")
                      return void e.reportError(a.MessageName.CYCLIC_DEPENDENCIES, `Dependency cycle detected (${n})`)
                    }
            ...
            ;(A.schema = i.object().shape({
              ...
              parallel: i.boolean().when("jobs", {
                is: e => e > 1,
                then: i.boolean().oneOf([!0], "--parallel must be set when using --jobs"),
                otherwise: i.boolean(),
              }),
            })),
              ...
              o([s.Command.Boolean("-a", { hidden: !0 })], A.prototype, "allLegacy", void 0),
              o(
                [
              ...
              o(
                [s.Command.Boolean("-A,--all", { description: "Run the command on all workspaces of a project" })],
                A.prototype,
                "all",
                void 0
              ),
              ...
              o(
                [s.Command.Boolean("-p,--parallel", { description: "Run the commands in parallel" })],
                A.prototype,
                "parallel",
                void 0
              ),
              ...
              o(
                [s.Command.Boolean("--no-private", { description: "Avoid running the command on private workspaces" })],
                A.prototype,
                "publicOnly",
                void 0
              ),
              o([s.Command.Path("workspaces", "foreach")], A.prototype, "execute", null)
          ...
          617: (e, t, n) => {
            ...
            e.exports = (e, t = {}) => {
              let n = (e, a = {}) => {
                ...
                if ("comma" === e.type) return "comma" === e.prev.type ? "" : l ? e.value : "|"
            ...
            e.exports = (e, t = {}) => {
              let n = void 0 === t.rangeLimit ? 1e3 : t.rangeLimit,
                i = (e, l = {}) => {
                  ...
                  let u = l,
                    p = l.queue
                  for (; "brace" !== u.type && "root" !== u.type && u.parent; ) (u = u.parent), (p = u.queue)
                  ...
                  if (e.nodes && e.ranges > 0) {
                    ...
                    let l = o(...i, t)
                    return 0 === l.length && (l = r(e, t)), p.push(s(p.pop(), l)), void (e.nodes = [])
                  }
                  let c = a.encloseBrace(e),
                    d = e.queue,
                    f = e
                  for (; "brace" !== f.type && "root" !== f.type && f.parent; ) (f = f.parent), (d = f.queue)
              ...
              const T = () => e[S++],
                k = e => {
                  if (
                    ...
                    return b.nodes.push(e), (e.parent = b), (e.prev = v), (v = e), e
                  v.value += e.value
                }
              for (k({ type: "bos" }); S < w; )
                if (((b = C[C.length - 1]), (_ = T()), _ !== R && _ !== y))
                      ...
                      if (_ !== f)
                        if (_ !== u)
                          if (_ !== p)
                            if (_ !== g && _ !== A && _ !== s)
                              if (_ !== c)
                                if (_ !== d)
                                  if (_ === i && H > 0) {
                                    ...
                                    if ("dot" === v.type) {
                                      if (
                                        ...
                                        ;(b.invalid = !0), (b.ranges = 0), (v.type = "text")
                                        continue
                                      }
                                      b.ranges++, (b.args = [])
                                      continue
                                    ...
                                    if ("range" === v.type) {
                                      e.pop()
                                      let t = e[e.length - 1]
                                      ;(t.value += v.value + _), (v = t), b.ranges--
                                      continue
                                    }
                                    k({ type: "dot", value: _ })
                                  ...
                                  let e = "close"
                                  ;(b = C.pop()), (b.close = !0), k({ type: e, value: _ }), H--, (b = C[C.length - 1])
                                }
                              else {
                                H++
                                let e = (v.value && "$" === v.value.slice(-1)) || !0 === b.dollar
                                ;(b = k({
                                  type: "brace",
                                  open: !0,
                                  close: !1,
                            ...
                            ;(b = C.pop()), k({ type: "text", value: _ }), (b = C[C.length - 1])
                          }
                        else (b = k({ type: "paren", nodes: [] })), C.push(b), k({ type: "text", value: _ })
                      else {
                        x++
                        let e
                        for (; S < w && (e = T()); )
                  ...
                  else k({ type: "text", value: (t.keepEscaping ? _ : "") + T() })
              do {
          ...
          169: (e, t, n) => {
            ...
            const o = n(669),
              ...
              f = (...e) => new RangeError("Invalid range arguments: " + o.inspect(...e)),
              h = (e, t, n) => {
              ...
              g = (e, t, n = 1, o = {}) => {
                ...
                let A = l(i) || l(h) || l(g),
                  ...
                  m = o.transform || (e => t => (!0 === e ? Number(t) : String(t)))(R)
                  ...
                  i(n)
                    ? i(e) && i(t)
                      ...
                      : ((e, t, n = 1, o = {}) => {
                          ...
                          let f = [],
                            g = 0
                          for (; l ? a >= s : a <= s; ) f.push(r(a, g)), (a = l ? a - n : a + n), g++
                          return !0 === o.toRegex ? d(f, null, { wrap: !1, options: o }) : f
          ...
          401: (e, t, n) => {
            const o = n(669),
              ...
              l = (e, t, n) => {
                ...
                let u = (i === t.length ? [...s] : [...r]).filter(e => !o.has(e))
                if (n && 0 === u.length) {
          ...
          974: (e, t, n) => {
            const o = n(86),
              ...
              d = (e, t) => {
                ...
                e = u[e] || e
                const n = { ...t },
                  d = "number" == typeof n.maxLength ? Math.min(a, n.maxLength) : a
                let f = e.length
            ...
            ;(d.fastpaths = (e, t) => {
              ...
              let C = !0 === n.bash ? ".*?" : y
              n.capture && (C = `(${C})`)
              const b = e => (!0 === e.noglobstar ? C : `(${E}(?:(?!${R}${e.dot ? f : p}).)*?)`),
                v = e => {
                  switch (e) {
                    case "*":
                      return `${m}${d}${C}`
          ...
          828: (e, t, n) => {
            const o = n(622),
              ...
              l = (e, t, n = !1) => {
                ...
                const d = (n, o = !1) => {
                  const { isMatch: r, match: s, output: d } = l.test(n, u, t, { glob: e, posix: i }),
                    f = { glob: e, state: p, regex: u, posix: i, input: n, output: d, match: s, isMatch: r }
                  return (
                    "function" == typeof a.onResult && a.onResult(f),
                    !1 === r
                      ? ((f.isMatch = !1), !!o && f)
                      : c(n)
                      ? ("function" == typeof a.onIgnore && a.onIgnore(f), (f.isMatch = !1), !!o && f)
                      : ("function" == typeof a.onMatch && a.onMatch(f), !o || f)
                  )
                }
            ...
            ;(l.test = (e, t, n, { glob: o, posix: r } = {}) => {
              ...
              return (
                !1 === u && ((p = i ? i(e) : e), (u = p === o)),
                (!1 !== u && !0 !== a.capture) ||
                  (u = !0 === a.matchBase || !0 === a.basename ? l.matchBase(e, t, n, r) : t.exec(p)),
              ...
              (l.parse = (e, t) => (Array.isArray(e) ? e.map(e => l.parse(e, t)) : a(e, { ...t, fastpaths: !1 }))),
              (l.scan = (e, t) => r(e, t)),
              ...
              (l.makeRe = (e, t, n = !1, o = !1) => {
                ...
                let s,
                  ...
                  u = ""
                return (
                  e.startsWith("./") && ((e = e.slice(2)), (u = i.prefix = "./")),
                  !1 === r.fastpaths || ("." !== e[0] && "*" !== e[0]) || (s = a.fastpaths(e, t)),
                  void 0 === s ? ((i = a(e, t)), (i.prefix = u + (i.prefix || ""))) : (i.output = s),
                  l.compileRe(i, t, n, o)
                )
              }),
              (l.toRegex = (e, t) => {
            ...
            e.exports = (e, t) => {
              ...
              for (; T < E; ) {
                ...
                if (((S = F()), S !== s)) {
                  ...
                  if (S !== p) {
                    if (!0 !== n.noext) {
                      if (!0 === (S === h || S === a || S === r || S === g || S === u) && H.charCodeAt(T + 1) === d) {
                    ...
                    if (S === r) {
                      if ((w === r && (B = j.isGlobstar = !0), (N = j.isGlob = !0), (U = !0), !0 === C)) continue
                      break
                    }
                    if (S === g) {
                    ...
                    if ((b.push(T), v.push(j), (j = { value: "", depth: 0, isGlob: !1 }), !0 === U)) continue
                    if (w === l && T === k + 1) {
                      k += 2
                      continue
                    }
              ...
              if (
                (!0 === n.tokens && ((q.maxDepth = 0), m(S) || v.push(j), (q.tokens = v)),
                ...
                for (let o = 0; o < b.length; o++) {
                  const r = t ? t + 1 : k,
                    ...
                    s = e.slice(r, a)
                  n.tokens &&
                    (0 === o && 0 !== k ? ((v[o].isPrefix = !0), (v[o].value = Q)) : (v[o].value = s),
                    _(v[o]),
                ...
                if (t && t + 1 < e.length) {
                  const o = e.slice(t + 1)
                  x.push(o),
                    n.tokens && ((v[v.length - 1].value = o), _(v[v.length - 1]), (q.maxDepth += v[v.length - 1].depth))
                }
          ...
          615: (e, t, n) => {
            ...
            const o = n(761),
              r = (e, t, n) => {
                ...
                let c = h(e) || h(t),
                  ...
                  f = [],
                  g = []
                if ((c && ((d.isPadded = c), (d.maxLen = String(d.max).length)), u < 0)) {
                  ;(g = s(p < 0 ? Math.abs(p) : 1, Math.abs(u), d, a)), (u = d.a = 0)
                }
                return (
                  p >= 0 && (f = s(u, p, d, a)),
                  (d.negatives = g),
                  ...
                  !0 === a.capture
                    ? (d.result = `(${d.result})`)
                    : !1 !== a.wrap && f.length + g.length > 1 && (d.result = `(?:${d.result})`),
                  (r.cache[l] = d),
                  d.result
                )
              }
            ...
            function i(e, t, n, o, r) {
              ...
              for (let r of e) {
                let { string: e } = r
                o || u(t, "string", e) || a.push(n + e), o && u(t, "string", e) && a.push(n + e)
              }
              return a
            }
            function l(e, t) {
